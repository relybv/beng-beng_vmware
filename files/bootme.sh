...
# install puppet
bash /root/beng_vmware/files/bootstrap.sh $PUPPETMAJOR
...
cp -a /root/beng_vmware/spec/fixtures/modules/* $MODULEDIR

echo "Run puppet apply"
/usr/local/bin/puppet apply -e "include beng_vmware"
